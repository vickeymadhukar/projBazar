...
export default function Login() {
  ...
  return (
    <div className="min-h-screen w-full bg-[#f3f3f3] flex items-center justify-center p-4 xl:p-6 font-sans selection:bg-purple-600 selection:text-white overflow-hidden">
      ...
      <div className="lg:hidden w-full max-w-[440px] flex flex-col justify-between relative pt-6 px-6 pb-11 min-h-[600px]">
        ...
        <div className="relative z-10 flex flex-col justify-between flex-1">
          <div>
            <h1 className="text-3xl font-extrabold text-neutral-850 tracking-tight leading-none mb-1">
              Welcome Back
            </h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-3.5 my-5">
            <div className="space-y-1">
              ...
              <div className="neu-input-container rounded-xl flex items-center px-4 w-full h-[52px]">
                <Mail size={16} className="text-neutral-400 mr-3 shrink-0" />
                <input
                  type="email"
            ...
            <div className="space-y-1">
              ...
              <div className="neu-input-container rounded-xl flex items-center px-4 w-full h-[52px] relative">
                <Lock size={16} className="text-neutral-400 mr-3 shrink-0" />
                <input
            ...
            <div className="flex items-center justify-between text-xs pt-1 px-1">
              <label className="flex items-center gap-2 cursor-pointer text-neutral-500">
                <div
                  ...
                  className="w-[18px] h-[18px] rounded flex items-center justify-center transition-all border border-black/[0.01]"
                  style={{ 
                    background: '#efefef', 
                    boxShadow: rememberMe ? NEU_DOWN : 'inset 2px 2px 5px rgba(0,0,0,0.03), inset -2px -2px 5px #fff' 
                  }}
                >
                  {rememberMe && <div className="w-2.5 h-2.5 rounded bg-purple-600 shadow-[0_0_8px_rgba(167,139,250,0.5)]" />}
                </div>
            ...
            <div className="pt-1.5">
              <motion.button
                ...
                whileHover={{ y: -3 }}
                whileTap={{ scale: 0.98 }}
                className="w-full h-[52px] rounded-xl flex items-center justify-center gap-2 border border-white/60 font-bold text-neutral-850 text-xs"
          ...
          <div className="flex flex-col items-center">
            <span className="text-[9px] uppercase font-bold tracking-widest text-neutral-450 mb-2">or continue with</span>
            <div className="flex gap-4">
              <button onClick={handleGoogleLogin} className="w-[56px] h-[56px] rounded-full flex items-center justify-center border border-white/50 bg-[#efefef]" style={{ boxShadow: NEU_BTN_UP }}>
              ...
              <button onClick={handleGithubLogin} className="w-[56px] h-[56px] rounded-full flex items-center justify-center border border-white/50 bg-[#efefef] text-neutral-850" style={{ boxShadow: NEU_BTN_UP }}>
              ...
              <button onClick={() => toast.error('Apple Login is currently in development.')} className="w-[56px] h-[56px] rounded-full flex items-center justify-center border border-white/50 bg-[#efefef] text-neutral-850" style={{ boxShadow: NEU_BTN_UP }}>
          ...
          <div className="text-center mt-4 text-[11px] text-neutral-500 font-semibold">
            Don't have an account? <Link to="/signup" className="text-purple-600 font-bold hover:underline">Create Account</Link>
          </div>
        </div>

      </div>

      {/* Desktop View: Unified Integrated 1200x900 card (Constrained to fit screen height) */}
      <div className="hidden lg:block w-full max-w-[1024px] h-[86vh] max-h-[640px] relative select-none z-10">
        ...
        <div className="absolute inset-0 grid grid-cols-12 items-center px-8 py-6 h-full">
          ...
          {/* Right Form side */}
          <div className="col-span-5 relative h-[95%] flex flex-col justify-center pl-4 pr-1">
            
            {/* The Login card container */}
            <div className="relative w-full h-full flex flex-col justify-between pt-12 pb-11 px-8 sm:px-10">
              
              {/* Login Card SVG backdrop */}
              <div className="absolute inset-0 w-full h-full pointer-events-none">
                <svg viewBox="0 0 700 900" className="w-full h-full login-panel-svg" preserveAspectRatio="none">
                  <path
                    d="M80 50 H230 L255 25 H620 L680 85 V820 L620 880 H80 L20 820 V110 L80 50 Z"
              ...
              <div className="relative z-10 flex flex-col justify-between flex-1">
                ...
                {/* Header */}
                <div>
                  <h1 className="text-2xl lg:text-[30px] font-extrabold text-neutral-850 tracking-tight leading-none mb-1.5">
                    Welcome Back
                  </h1>
                ...
                <form onSubmit={handleSubmit} className="space-y-3.5 my-auto py-2">
                  ...
                  {/* Email address */}
                  <div className="space-y-1">
                    <label className="block text-[9px] font-bold text-neutral-450 uppercase tracking-wider pl-1">
                      Email Address
                    </label>
                    <div className="neu-input-container rounded-xl flex items-center px-4 w-full h-[52px]">
                      <Mail size={16} className="text-neutral-400 mr-3 shrink-0" />
                  ...
                  <div className="flex items-center justify-between text-xs pt-0.5 px-1">
                    <label className="flex items-center gap-2 cursor-pointer text-neutral-500 hover:text-neutral-700 transition-colors">
                      <div
                        onClick={() => setRememberMe(!rememberMe)}
                        className="w-[16px] h-[16px] rounded flex items-center justify-center transition-all border border-black/[0.01]"
                        style={{ 
                          background: '#efefef', 
                          boxShadow: rememberMe ? NEU_DOWN : 'inset 2px 2px 5px rgba(0,0,0,0.03), inset -2px -2px 5px #fff' 
                        }}
                    ...
                    <a href="#forgot" className="font-semibold text-purple-600 hover:text-purple-755 hover:underline text-[11px]">
                      Forgot password?
                    </a>
                  </div>
                ...
                <div className="flex flex-col items-center pt-1">
                  <span className="text-[9px] uppercase font-bold tracking-widest text-neutral-450 mb-2">
                    or continue with
                  </span>
                  ...
                  <div className="flex gap-4">
                    <motion.button
                      ...
                      whileHover={{ y: -3 }}
                      whileTap={{ scale: 0.95 }}
                      className="w-[56px] h-[56px] rounded-full flex items-center justify-center border border-white/50 bg-[#efefef] outline-none cursor-pointer"
                    ...
                    <motion.button
                      ...
                      whileHover={{ y: -3 }}
                      whileTap={{ scale: 0.95 }}
                      className="w-[56px] h-[56px] rounded-full flex items-center justify-center border border-white/50 bg-[#efefef] outline-none cursor-pointer text-neutral-800"
                      style={{ boxShadow: NEU_BTN_UP }}
                    >
                    ...
                    <motion.button
                      type="button"
                      onClick={() => toast.error('Apple Login is currently in development.')}
                      whileHover={{ y: -3 }}
                      whileTap={{ scale: 0.95 }}
                      className="w-[56px] h-[56px] rounded-full flex items-center justify-center border border-white/50 bg-[#efefef] outline-none cursor-pointer text-neutral-800"
                      style={{ boxShadow: NEU_BTN_UP }}
                ...
                <div className="relative select-none mt-2">
                  <div className="absolute inset-0 w-full h-[52px] flex items-center justify-center">
                    <svg viewBox="0 0 460 120" className="w-full h-[52px]" preserveAspectRatio="none" style={{ filter: 'drop-shadow(0 4px 10px rgba(0,0,0,0.03))' }}>
                      <path 
                  ...
                  <div className="relative z-10 flex items-center justify-center h-[52px] text-[11px] text-neutral-500 font-semibold gap-1">
                    <span>Don't have an account?</span>
                    <Link to="/signup" className="text-purple-600 font-bold hover:text-purple-750 flex items-center gap-1.5 hover:underline">
